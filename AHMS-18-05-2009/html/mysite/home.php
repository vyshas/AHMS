...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr bgcolor="#D5EDB3">
    ...
    <td width="82">&nbsp;&nbsp;</td> <td width="82">&nbsp;&nbsp;</td>
  </tr>

  <tr bgcolor="#D5EDB3">
    <td height="50" colspan="3" id="tagline" valign="top" align="center">AUTOMATED HIERARCHICAL MANAGEMENT SYSTEM </td>
	<td width="82">&nbsp;&nbsp;</td>
  </tr>
  ...
  <tr>
    <td colspan="7" bgcolor="#99CC66" background="mm_dashed_line.gif"><img src="mm_dashed_line.gif" alt="line decor" width="2" height="3" border="0" /></td>
  </tr>
 ...
 <tr>
    <td width="165" height="493" valign="top" bgcolor="#5C743D">
    ...
    <td colspan="2" valign="top"><p><img src="mm_spacer.gif" alt="" width="305" height="1" border="0" /></p>
      <table width="504" height="329" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="504" height="33" class="pageName"><p>What is AHMS?</p>          </td>
		</tr>

		<tr>
          <td class="bodyText"><p class="style2">Automated Hierarchical Management System allows User-System   			interaction by providing a pre-defined set of services. </p>
            <p class="style2">AHMS can be implemented in any organization following&nbsp;   			hierarchical workflow such as Government Organizations, Educational   			Institutions, IT Companies......</p>
		    <p class="style2">This system provides automation which leads to the reduction in   			transaction costs, less paper-work and manual processing.</p>
	      <p class="style1"><span class="style2"><strong>This system ensures that there is no room for mismanagement by   			assuring service to the user .</strong></span>&nbsp;&nbsp;&nbsp; </p></td>
        </tr>
      </table>
	 <p><br />
	  &nbsp;</p>
	<p>&nbsp;</p>	</td>
    <td width="579"><img src="mm_spacer.gif" alt="" width="50" height="1" border="0" /></td>
